...
import { BarChart3, FileText, Images, Inbox, Palette, Paintbrush, ExternalLink, LogOut } from "lucide-react";
import { redirect } from "next/navigation";
import { isAuthenticated } from "@/lib/auth";
import "../admin.css";
import "../admin-enhancements.css";
const links = [["/admin",BarChart3,"Overview"],["/admin/pages",FileText,"Pages"],["/admin/appearance",Paintbrush,"Appearance"],["/admin/designs",Palette,"Uniform designs"],["/admin/media",Images,"Media"],["/admin/enquiries",Inbox,"Enquiries"]] as const;
